...
def main():    
    ...
    st.sidebar.markdown('📧<qyutony@163.com>')
...
if session_state.AccessCode != 'TAILab':

    head_placeholder = st.empty()
    pwd_placeholder = st.empty()

    head = head_placeholder.subheader('©TAILab')
    ...
    if session_state.AccessCode == 'TAILab':
        ...
        st.error("Access denied! Please check https://github.com/qyu6/TAILab or scan **TAILab [QR-Code]** below to get TAILab access code.")
